...
pandoc journalpublications.bib -s --template=journalpublications-template.html --metadata link-bibliography --csl ieee.csl --metadata title="Journal Publications" --citeproc -o journalpublications.html

bibtool -- 'select{keywords "selected"}' publis.bib -o selectedpublications.bib
pandoc selectedpublications.bib -s --template=selectedpublications-template.html --metadata link-bibliography --csl ieee.csl --metadata title="Selected Publications" --citeproc -o selectedpublications.html
